...
def backup_historical_data_dag():
    ...
    def backup_past_data() -> list:
        current_content_no = int(Variable.get("start_content_no", default_var=385))
        saved_file_paths = []
        ...
        while True:
            ...
            logger.info(f"Backed up post {current_content_no} to {parquet_file_path} and {csv_file_path}")
    ...
    table_id = "blackdesert_mobile_hub_scraping_backup"
